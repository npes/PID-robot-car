...
//variables for PID functions
  const float Kp_value = 4;
    const float Ki_value = 0.5;
...
// ======================================= Function prototypes =======================================
  ...
  int PIDFunctionL(int DutyL, int SetPointL, float ErrorL); // PID function for motor control. requires pwm input as starting point
  int PIDFunctionR(int DutyR, int SetPointR, float ErrorR); // PID function for motor control. requires pwm input as starting point
...
void loop() {
  ...
  if(PIDFlag == 1){
    ...
    old_DutyL = PIDFunctionL(old_DutyL , setPointL, EPchangeL);
    old_DutyR = PIDFunctionR(old_DutyR , setPointR, EPchangeR);
...
/* ************************************ PID functions ********************************* */
  // ================================== PID function L ================================
  int PIDFunctionL(int DutyL, int SetPointL, float ErrorL){
...
// PID function R
  int PIDFunctionR(int DutyR, int SetPointR, float ErrorR){
