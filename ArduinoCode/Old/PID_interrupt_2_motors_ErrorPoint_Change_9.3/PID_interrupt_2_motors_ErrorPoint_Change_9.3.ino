...
// PID functions 
  ...
  const float Ki_value = 0.0008;
  const float Kd_value = 2.15; // 1: (2.35 - 2.5) ; 2: (3.9 - 4) ; 3: 4.9
...
// setpoint in Hz
  int EXT_SetPoint = 40; // standard 40
...
// Freq. for each tacho
  unsigned int TachoLeftFreq = 0;
  unsigned int TachoRightFreq = 0;
...
//Read BlueTooth buttons  
  ...
  // func_BTGraph(TachoLeftFreq, TachoRightFreq, EXT_SetPoint); 
...
/* ================================== PID function L =============================== */
  int PIDFunctionL(int PWMSignal, int InputSetPoint){
    ...
    ReadSensors();
    int SetPoint = InputSetPoint+EPchangeL;
...
/* ================================== PID function R =============================== */
  int PIDFunctionR(int PWMSignal, int InputSetPoint){
    ...
    ReadSensors();
    int SetPoint = InputSetPoint+EPchangeR; 
    short int old_PWM = PWMSignal; // store function input (pwm) for use in function
    short int New_PWM = 0;
...
/* ********************************* Tachometer readings ****************************** */
  void ReadTacho()
  {
    ...
    /*Serial.print("TimePerleft : ");
    Serial.print(LeftTimePeriod);
    Serial.print(" ");*/
    ...
    /*Serial.print("TimePerright : ");
    Serial.print(RightTimePeriod);
    Serial.println(" ");*/
